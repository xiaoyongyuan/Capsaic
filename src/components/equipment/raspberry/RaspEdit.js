import {Col,Row, Button, Select, Form, Input, Slider, Radio ,Checkbox,message } from "antd";
...
class RaspEdit extends Component {
    ...
    getbaseinfodate = (equipData) =>{
        ...
        this.props.form.setFieldsValue({
            ...
            nvrvalue:nvrvalue,
            projecttype:equipData.relations.projecttype
        });
    };
    //编辑外接设备时调用
            ...
            if (err) {
                ...
                axios.ajax({
                    ...
                    data: {
                        ...
                        projecttype:fields.projecttype,//设备类型
                            ...
                            <Form.Item label="设备类型">
                                {getFieldDecorator('projecttype', {
                                    ...
                                    <Select placeholder="请选择设备类型" disabled>
                                        <Option value="1">围界设备</Option>
                                        <Option value="2">人脸设备</Option>
                                    </Select>
                                )}
                            </Form.Item>
