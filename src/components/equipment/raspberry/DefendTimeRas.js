...
import {Button,message, Icon, Modal, Form, Checkbox, Radio, Divider} from "antd";
        ...
        >
          <Form layout="vertical">
            ...
            <Form.Item label=" " key="delete">
              <div className="delFiled">
                <span>删除星期{day[btnNum]}的布防时间</span>
                <Radio
...
class DefendTime extends Component {
  ...
  renderTable = () => {
    ...
    var rows = 7;
    var htmlstr =
      "<table  id='tab' style='border-collapse: separate; border-spacing: 0 55px;' width='600'>";
    ...
    return (
      ...
      >
        <div>
          ...
          >
            <Button className="delete" title="操作布防时间">
              <Icon type="setting" />
            </Button>
            <Button className="delete" title="操作布防时间">
              <Icon type="setting" />
        ...
        <div className="defaendOPerBtn">
          <Button id="deleteData" type="danger">清除全部</Button>
          <Button
              id="submitData"
              type="primary"
