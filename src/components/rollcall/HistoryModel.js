    ...
    hanleHistoryDetail=(params)=>{
        axios.ajax({
            ...
            if(res.success){
                ...
                this.setState({
                    historyName:res.data.raname && res.data.eid?res.data.raname+"-"+res.data.eid:"无",
                    resultdate:res.data.resultdate,
    ...
    render() {
        return (
            <div className="historyModel">
                <p className="historyTitle">{this.state.historyName}</p>
