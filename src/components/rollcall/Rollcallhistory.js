...
import {Form,DatePicker,Input,Select,Button,Row,Col,Pagination,Empty,Modal,Breadcrumb} from "antd";
        ...
        return(
            <div className="rollcallhistory">
                <Breadcrumb className="crumbs">
                    ...
                    <Breadcrumb.Item>
                        <span className="crumbs-item">点名历史</span>
                    </Breadcrumb.Item>
                </Breadcrumb>
                    ...
                    <Row gutter={[32,32]}>
                        {
                            this.state.rollhistoryList.length>0?
                                ...
                                <Col xxl={4} xl={6} lg={8}  key={i} className="gutter-row">
                                    <div className="gutter-box" onClick={()=>this.hanleHistoryDetail(v.code)}>
                                        ...
                                        <div className="rollHist-con">
                                            <p className="roll-context">{v.rname && v.eid? v.rname+"-"+v.eid:"无"}</p>
                                            <p className="roll-context">{v.resultdate}</p>
